...
public class HtmlRenderer implements ItemRenderer {
    static private HtmlRenderer instance;   // singleton
    
    /** インスタンスを取得する(singleton) 
        @return HtmlRenderer のインスタンス
    */
    static public HtmlRenderer getInstance() {
